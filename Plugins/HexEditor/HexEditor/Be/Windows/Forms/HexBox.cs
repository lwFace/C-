namespace Be.Windows.Forms
{
    ...
    public class HexBox : Control
    {
        ...
        private Color _headerColor = Color.Maroon;
        ...
        private void _vScrollBar_Scroll(object sender, ScrollEventArgs e)
        {
            switch (e.Type)
            {
                ...
                case ScrollEventType.ThumbPosition:
                {
                    ...
                    this.PerformScrollThumbPosition(pos);
                    break;
                }
                case ScrollEventType.ThumbTrack:
                {
                    long num2 = this.FromScrollPos(e.NewValue);
                    this.PerformScrollThumbPosition(num2);
                    break;
                }
            }
        ...
        #endregion 私有函数实现
        public int CalculateMaxVisibleBytesPerLineForWidth(int iWidth)
        {
            iWidth -= ((this._vScrollBar.Width + 4) + this._recBorderLeft) + this._recBorderRight;
            if (iWidth < 1)
            {
                return 0;
            }
            int num = (int) Math.Ceiling((double) base.CreateGraphics().MeasureString("A", this.Font, 100, this._stringFormat).Width);
            ...
            return (int) Math.Floor((double) (((double) iWidth) / ((double) num2)));
        }
        #region 判断是否可以复制粘贴
        public bool CanCopy()
        {
        ...
        public void Copy()
        {
            if (this.CanCopy())
            {
                byte[] bytes = new byte[this._selectionLength];
                int index = -1;
                for (long i = this._bytePos; i < (this._bytePos + this._selectionLength); i += 1L)
                {
                    index++;
                    bytes[index] = this._byteProvider.ReadByte(i);
                }
        ...
        private void CreateCaret()
        {
            ...
            {
                Be.Windows.Forms.NativeMethods.CreateCaret(base.Handle, IntPtr.Zero, 1, (int) this._charSize.Height);
                this.UpdateCaret();
                Be.Windows.Forms.NativeMethods.ShowCaret(base.Handle);
        ...
        private void DestroyCaret()
        {
            ...
            {
                Be.Windows.Forms.NativeMethods.DestroyCaret();
        ...
        private void PaintHexAndStringView(Graphics g, long startByte, long endByte)
        {
            ...
            Brush brush2 = new SolidBrush(this._selectionForeColor);
            Brush brushBack = new SolidBrush(this._selectionBackColor);
            Brush brush4 = new SolidBrush(this._headerColor);
            int num = -1;
            long num2 = Math.Min((long) (this._byteProvider.Length - 1L), (long) (endByte + this._iHexMaxHBytes));
            bool flag = (this._keyInterpreter == null) || (this._keyInterpreter.GetType() == typeof(KeyInterpreter));
            ...
            for (long i = startByte; i < (num2 + 1L); i += 1L)
            {
                ...
                {
                    this.PaintHexString(g, b, (i < this._bodyOffset) ? brush4 : brush, gridBytePoint);
                }
                ...
                {
                    g.DrawString(str, this.Font, (i < this._bodyOffset) ? brush4 : brush, byteStringPointF, this._stringFormat);
                }
            }
        }
        ...
        private void PaintLineInfo(Graphics g, long startByte, long endByte)
        {
            ...
            for (int i = 0; i < num; i++)
            {
                ...
                if (num4 > -1)
                {
                    str2 = new string('0', 8 - str.Length) + str;
                }
                else
                {
                    str2 = new string('~', 8);
        ...
        private void PerformScrollThumbPosition(long pos)
        {
        ...
        private void UpdateCaret()
        {
            if ((this._byteProvider != null) && (this._keyInterpreter != null))
            {
                ...
                Be.Windows.Forms.NativeMethods.SetCaretPos((int) caretPointF.X, (int) caretPointF.Y);
            }
        }
        ...
        private void UpdateScrollSize()
        {
            ...
            {
                long num = (long) Math.Ceiling((double) ((((double) this._byteProvider.Length) / ((double) this._iHexMaxHBytes)) - this._iHexMaxVBytes));
                num = Math.Max(0L, num);
        ...
        [Category("Hex"), Description("Gets or sets the maximum count of bytes in one line."), DefaultValue(0x10)]
        ...
        [DefaultValue(typeof(Be.Windows.Forms.HexCasing), "Upper"), Description("Gets or sets whether the HexBox control displays the hex characters in upper or lower case."), Category("Hex")]
        public Be.Windows.Forms.HexCasing HexCasing
        {
            get
            {
                if (this._hexStringFormat == "X")
                {
                    return Be.Windows.Forms.HexCasing.Upper;
                }
                return Be.Windows.Forms.HexCasing.Lower;
            }
            set
            {
                string str;
                if (value == Be.Windows.Forms.HexCasing.Upper)
                {
                    str = "X";
                }
                else
        ...
        [Description("Gets or sets the visibility of a line info."), DefaultValue(false), Category("Hex")]
        ...
        [Description("Gets or sets if the control is readonly."), DefaultValue(false), Category("Hex")]
        ...
        [Description("Gets or sets the visibility of a shadow selection."), Category("Hex"), DefaultValue(true)]
        ...
        [DefaultValue(false), Description("Gets or sets the visibility of the string view."), Category("Hex")]
        ...
        [DefaultValue(""), DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden), Browsable(false), Bindable(false), EditorBrowsable(EditorBrowsableState.Never)]
        ...
        [DefaultValue(false), Description("Gets or sets the visibility of a vertical scroll bar."), Category("Hex")]
        ...
        private class KeyInterpreter : HexBox.IKeyInterpreter
        {
            ...
            public virtual bool PreProcessWmChar(ref Message m)
            {
                ...
                if (!this.RaiseKeyPress(character))
                {
                    ...
                    if ((!flag4 && flag2) && (this._hexBox._insertActive && (byteCharacterPos == 0)))
                    {
                        flag4 = true;
                    }
            ...
            public virtual bool PreProcessWmKeyDown(ref Message m)
            {
                ...
                switch (keyData)
                {
                    ...
                    case (Keys.Shift | Keys.Prior):
                        return this.PreProcessWmKeyDown_ShiftPageUp(ref m);

                    case (Keys.Shift | Keys.Next):
                        return this.PreProcessWmKeyDown_ShiftPageDown(ref m);
            ...
            protected virtual bool PreProcessWmKeyDown_ShiftDown(ref Message m)
            {
                ...
                else
                {
                    ...
                    else if (start < this._bpiStart.Index)
                    {
            ...
            protected virtual bool PreProcessWmKeyDown_ShiftPageDown(ref Message m)
            {
                long start = this._hexBox._bytePos;
                long length = this._hexBox._selectionLength;
                long num3 = this._hexBox._byteProvider.Length;
                if (((start + length) + this._hexBox._iHexMaxBytes) <= num3)
                {
                    if (this._bpiStart.Index <= start)
                    {
                        length += this._hexBox._iHexMaxBytes;
                        this._hexBox.InternalSelect(start, length);
                        this._hexBox.ScrollByteIntoView(start + length);
                    }
                    else
                    {
                        ...
                        {
                            start += this._hexBox._iHexMaxBytes;
                            length -= this._hexBox._iHexMaxBytes;
                        }
                        this._hexBox.InternalSelect(start, length);
                        this._hexBox.ScrollByteIntoView();
            ...
            protected virtual bool PreProcessWmKeyDown_ShiftPageUp(ref Message m)
            {
                long start = this._hexBox._bytePos;
                long length = this._hexBox._selectionLength;
                if (((start - this._hexBox._iHexMaxBytes) >= 0L) || (start > this._bpiStart.Index))
                {
            ...
            protected virtual bool PreProcessWmKeyUp_Insert(ref Message m)
            {
                ...
                this._hexBox.OnInsertActiveChanged(EventArgs.Empty);
                return true;
            }
        ...
        private class StringKeyInterpreter : HexBox.KeyInterpreter
        {
            ...
            public override bool PreProcessWmChar(ref Message m)
            {
                ...
                if (!base.RaiseKeyPress(keyChar))
                {
                    ...
                    if ((!flag4 && flag2) && base._hexBox._insertActive)
                    {
                        flag4 = true;
                    }
                    if ((flag3 && flag2) && (length > 0L))
            ...
            public override bool PreProcessWmKeyDown(ref Message m)
            {
                ...
                if (keys == Keys.Escape)
                {
                    base._hexBox.InternalSelect(base._hexBox._bytePos, 0L);
                    return true;
                }
                Keys keyData = keys | Control.ModifierKeys;
                Keys keys3 = keyData;
